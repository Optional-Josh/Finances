from main_menu_gui import Top_Frame, Bottom_Frame
...
class Main_Window(ctk.CTk):
    def __init__(self):
        ...
        self.bottom_frame = Bottom_Frame(self) # create bottom frame object into window with top frame as parameter
